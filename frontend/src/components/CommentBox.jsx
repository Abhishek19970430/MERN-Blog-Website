...
const CommentBox = ({ selectedBlog }) => {
    ...
    useEffect(() => {
        const getAllCommentsOfBlog = async () => {
            try {
                const res = await axios.get(`https://blog-backend-0fl9.onrender.com/api/v1/comment/${selectedBlog._id}/comment/all`)
    ...
    const commentHandler = async () => {
        try {
            const res = await axios.post(`https://blog-backend-0fl9.onrender.com/api/v1/comment/${selectedBlog._id}/create`, { content }, {
                headers: {
    ...
    const deleteComment = async (commentId) => {
        try {
            const res = await axios.delete(`https://blog-backend-0fl9.onrender.com/api/v1/comment/${commentId}/delete`, {
                withCredentials: true
            })
            if (res.data.success) {
    ...
    const editCommentHandler = async (commentId) => {
        try {
            const res = await axios.put(
                `https://blog-backend-0fl9.onrender.com/api/v1/comment/${commentId}/edit`,
     ...
     const likeCommentHandler = async (commentId) => {
         try {
             const res = await axios.get(
                 `https://blog-backend-0fl9.onrender.com/api/v1/comment/${commentId}/like`,
                 {
                     withCredentials: true,
                 }
             );
