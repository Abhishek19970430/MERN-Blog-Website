...
const TotalProperty = () => {
    ...
    const getTotalComments = async()=>{
        try {
          const res = await axios.get(`http://localhost:8000/api/v1/blog/api/v1/comment/my-blogs/comments`,{withCredentials:true})
          if(res.data.success){
    ...
    const getTotalLikes = async()=>{
      try {
        const res = await axios.get(`http://localhost:8000/api/v1/blog/api/v1/blog/my-blogs/likes`,{withCredentials:true})
        if(res.data.success){
